"use strict";
! function(a) {
    function t(t) { var i = a(a(t).parents(".imgfix_wrapper_layer")[0]),
    ...
    function i(t, e) { a("#imgfix_cover_slide_for_" + e).remove(); var i = a(t).parents(".imgfix_top_container")[0];
        a(i).off(); var r = t.data("slide"); switch (s(t), r) {
            case "in-up":
            case "in-right":
            case "in-down":
            case "in-left":
            ...
            case "out-down":
            case "out-left":
                t.addClass("imgfix-" + r); break;
            case "dynamic":
                t.addClass("imgfix-in-up"), a(i).on("mouseenter", t, function(t) { var e = t.data.parents(".imgfix_wrapper_layer")[0].id.split("_")[3],
                        i = a(l.family[e].element);
                    a(this).find(".imgfix_cover_wrapper").removeClass("imgfix-in-up-right"), a(this).find(".imgfix_cover_wrapper").removeClass("imgfix-in-up-left"), a(this).find(".imgfix_cover_wrapper").removeClass("imgfix-in-down-right"), a(this).find(".imgfix_cover_wrapper").removeClass("imgfix-in-down-left"); for (var r = 0; r < i.length; r++) { var f = i[r]; if (f != this) { var d = "";
                        ...
                        i = a(l.family[e].element); if (!i.find(":hover").length) { var r = void 0 == t.offsetX ? t.pageX - a(this).offset().left : t.offsetX,
                            f = void 0 == t.offsetY ? t.pageY - a(this).offset().top : t.offsetY,
                            d = "";
                        d = f < .1 * t.data.height() ? "down" : f > .9 * t.data.height() ? "up" : r < .1 * t.data.width() ? "left" : "right", t.data.addClass("imgfix-in-" + d), s(t.data, "imgfix-in-" + d) } }); break;
            default:
                return }
    ...
    function r(t, e) { a("#imgfix_cover_fade_for_" + e).remove(); var i = t.data("fade"),
            s = new Object; switch (i) {
            case "in":
                s = { from: { opacity: 0 }, to: { opacity: 1 } }; break;
            case "out":
                s = { from: { opacity: 1 }, to: { opacity: 0 } }; break;
            default:
                return }
    ...
    a.fn.imgfix = function(t) { for (var e = -1, i = !1, s = 0; s < l.family.length; s++) { var r = !0; for (var f in this) this[f] != l.family[s].element[f] && (r = !1); if (r) { e = s, i = !0; break } }
        0 > e && (l.family.push(new Object), e = l.family.length - 1), l.family[e] = { id: e, element: this, parameters: t }, l.init(l.family[e], i), a(window).resize(function() { l.init(l.family[e], !0) }) }, a.fn.imgfixRefresh = function() { for (var t = a(this).find(".imgfix_wrapper_layer"), e = new Array, i = 0; i < t.length; i++) { var s = t[i].id.split("_")[3];
            e[s] = !0 } for (var r in e) l.init(l.family[r]) } }(jQuery);