          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
				...
				<input type='submit' value='Accept' name='comment_admin' class='btn btn-default'><input type='submit' value='Delete' name='comment_admin' class='btn btn-danger'></form></td>";
                            }
                          }
                        ?>
                    </table>
